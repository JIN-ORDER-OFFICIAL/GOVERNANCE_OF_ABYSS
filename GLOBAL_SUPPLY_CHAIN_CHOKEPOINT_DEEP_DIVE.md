...
![GLOBAL_SUPPLY_CHAIN_CHOKEPOINT_DEEP_DIVE](./assets/GLOBAL_SUPPLY_CHAIN_CHOKEPOINT_DEEP_DIVE.jpg)
...
［中東・カタール等］──(ホルムズ海峡途絶)──▶【高純度ヘリウム (世界供給30-40%喪失)】
│ (EUV露光パージ・ウェハー裏面冷却停止)
［特定日本・台湾サプライチェーン］─────────▶【T-Glass極薄ガラスクロス (熱歪み防止)】
│ (次世代AIパッケージ基板の反り・破綻)
［単一化学サプライチェーン (味の素等)］───▶【ABFフィルム (微細配線絶縁層)】
│ (次世代GPU/アクセラレータ出荷上限キャップ)
▼
【 世界先端メガファブの同時ライン停止 (BLACKOUT) 】
